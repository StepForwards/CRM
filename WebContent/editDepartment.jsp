	...
	<form action="${pageContext.request.contextPath }/updateKindINfo">
		<table style="margin: 0 auto;">
			<tr>
				...
				<td><input type="hidden" name="d_id" value="${department.d_id }" >
					<input type="hidden" name="kind" value="department">				
					<input type="text" placeholder="填写部门名称" name="d_name" value="${department.d_name }" style="width: 800px; height: 50px;" >
				</td>
			</tr>
				<td>部门描述</td>
				<td>
